...
function createAccount(type, determinant) {
    ...
    while(!mdpValide(mdp)){
        mdp = prompt(`Mot de passe invalide (Minimum 8 caractères dont 1 caractère spécial ou 1 chiffre et au moins 1 majuscule). \nMerci de recommencer ou quitter avec EXIT : `);
        if(mdp === "EXIT")
        {
            console.log("Vous allez être redirigé vers le menu.");
            return;
