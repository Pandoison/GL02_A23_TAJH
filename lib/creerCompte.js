...
* prenom String
*/
var prenomValide = function(prenom){
    const caractereAutorise = /^[a-zA-Z]+$/;
...
* email String
*/
var emailValide = function(email){
...
* Cree ensuite une VCard et un espace etudiant si necessaire et sauvegarde les données de ce nouvelle utilisateur
* param :
...
module.exports = {chooseTypeAccount, nomValide, prenomValide, emailValide, telValide, mdpValide};
