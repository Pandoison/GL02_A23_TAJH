...
const deleteQuestionFromGift = (questionName) => {
    ...
    const newFileContent = currentFileContent.replace(re, '')
...
// (::U9 p95 4\.2 Third conditional.*\n)(.+\n)*

// deleteQuestionFromGift("U9 p95 4.2 Third conditional")

module.exports = {generateQuestion, convertQuestionToGift, deleteQuestionFromGift}
