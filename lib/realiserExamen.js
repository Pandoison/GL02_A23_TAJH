    ...
    if (etudiant) {
        ...
        if (files.includes(examenFileName)) {
            ...
            try {
                ...
                afficherRelecture(examenChoisiDetails);
...
function afficherRelecture(examenDetails) {
    ...
    examenDetails.questions.forEach((question, index) => {
        ...
        // Affichez les réponses en fonction du type de question
        switch (question.type) {
            case 'MC':
            ...
            case 'Essay':
                ...
                break;
            // Ajoutez des cas pour les autres types de questions si nécessaire
        }
