...
// console.log(questions);
    ...
    //const professeur = prompt("Rentrez votre nom et votre prenom de la manière suivante : NOM_Prenom, pour inclure votre Vcard dans l'examen");
    ...
    //fichiers.forEach(file => {
      //  const filepath = path.join(pathToContacts, file);
        //if (file.includes(nomPrenomProfesseur)) {
